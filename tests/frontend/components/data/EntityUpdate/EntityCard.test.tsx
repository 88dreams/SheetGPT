...
jest.mock('../../../../../frontend/src/components/data/EntityUpdate/QuickEditForm', () => ({
...
jest.mock('../../../../../frontend/src/components/data/EntityUpdate/AdvancedEditForm', () => ({
...
jest.mock('../../../../../frontend/src/components/data/EntityUpdate/EntityRelatedInfo', () => {
  return {
    __esModule: true,
...
describe('EntityCard', () => {
  ...
  it('handles entity updates correctly', async () => {
    ...
    const { useApiClient } = require('../../../../../frontend/src/hooks/useApiClient');
